...
if (!process.env.DB_NAME) process.env.DB_NAME = 'arbitra_test';
...
if (!process.env.ARBITRA_AGREEMENT_CONTRACT_ID)
  process.env.ARBITRA_AGREEMENT_CONTRACT_ID = E2E_CONTRACT_ID;
