...
import { ArbitraAgreementContractService } from '../src/modules/stellar/services/arbitra-agreement-contract.service';
...
describe('Blockchain Integration (e2e)', () => {
  ...
  let _arbitraAgreementContract: ArbitraAgreementContractService;
    ...
    const moduleFixture: TestingModule = await Test.createTestingModule({
      imports: [
        ...
        TypeOrmModule.forRoot({
          ...
          database: process.env.DB_NAME || 'arbitra_test',
