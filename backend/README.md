...
NestJS REST API for the Arbitra rental payment platform. Handles authentication, property listings, rent agreements, payments, Stellar blockchain integration, disputes, and KYC.
