...
<body>
  <div style="padding: 20px;">
    <div class="container">
      ...
      <div class="footer">
        <p>Arbitra Protocol &mdash; Decentralized Housing on Stellar</p>
        <p>You received this email because you have an account with Arbitra.</p>
      </div>
    </div>
  </div>
</body>
...
export function verificationEmailTemplate(
  ...
  return wrapInLayout(
    'Verify Your Email',
    `
    <h2>Welcome to Arbitra${data.recipientName ? `, ${data.recipientName}` : ''}!</h2>
...
export function kycStatusUpdateTemplate(
  ...
  return wrapInLayout(
    ...
    ${data.status === 'approved' ? '<p>You now have full access to all Arbitra features.</p>' : ''}
    `,
  );
}
