...
Comprehensive documentation of the Arbitra authentication system, covering architecture, JWT and Stellar auth flows, MFA, password policies, guards, decorators, rate limiting, metrics, and security considerations.
...
Arbitra supports TOTP-based MFA using authenticator apps (Google Authenticator, Authy, etc.).
