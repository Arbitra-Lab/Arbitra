...
This document defines procedures for integrating third-party APIs and webhooks into the Arbitra backend, covering integration patterns, testing, error handling, retry logic, and monitoring.
...
grep "Retry-After" /var/log/arbitra/integration.log
```
...
# Check webhook logs
docker logs arbitra-backend | grep "webhook"
