...
This document provides a detailed description of the Arbitra database schema, entity relationships, data flow patterns, and key design decisions. It serves as the definitive reference for understanding how data is structured and connected across the platform.
