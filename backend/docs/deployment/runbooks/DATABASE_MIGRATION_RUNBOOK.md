...
This runbook provides step-by-step procedures for safely creating, testing, and applying database migrations in the Arbitra platform. Use this whenever you need to modify the database schema.
