...
This document covers configuration management for the Arbitra backend across all environments. It defines environment variable standards, configuration file structure, validation procedures, environment-specific setups, secrets handling, versioning, deployment, and troubleshooting.
...
- Database name is `arbitra_staging` — isolated from development and production.
