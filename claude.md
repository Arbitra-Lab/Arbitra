...
- `arbitra/` - Main contract with emergency pause mechanism
...
- Emergency pause mechanism (Arbitra contract)
...
cd contract && cargo build -p arbitra --target wasm32-unknown-unknown --release
