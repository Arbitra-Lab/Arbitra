...
A complete document management system for the Arbitra rental platform with upload, viewing, and management capabilities.
...
All components use Tailwind CSS and follow the Arbitra design system:
