              ...
              >
                <div className="flex items-start justify-between gap-2 mb-2">
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-neutral-200/60 mt-0.5 truncate">
                      {field.value || 'Empty'}
                    </p>
                  </div>
                  <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    {!field.isPublic && (
                      <EyeOff size={14} className="text-neutral-200/60" />
                    )}
                    {field.isCustom && (
                      <span className="px-2 py-0.5 rounded-full text-xs bg-white/10 border border-white/20 text-neutral-200/80">
                        Custom
                      </span>
                    )}
                  </div>
