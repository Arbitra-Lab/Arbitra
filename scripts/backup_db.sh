...
# ==============================================================================
# Database Backup Script for Arbitra (PostgreSQL)
# ==============================================================================
# This script creates a compressed backup of the arbitra_db database running
# inside the 'arbitra_db' Docker container. It automatically manages retention
...
#
# 0 2 * * * /absolute/path/to/arbitra/scripts/backup_db.sh > /absolute/path/to/arbitra/backups/backup.log 2>&1
# ==============================================================================

set -e # Exit immediately if a command exits with a non-zero status

# Configuration
CONTAINER_NAME="arbitra_db"
...
BACKUP_FILE="${BACKUP_DIR}/arbitra_db_${TIMESTAMP}.sql.gz"
...
cleanup_count=$(find "$BACKUP_DIR" -maxdepth 1 -name "arbitra_db_*.sql.gz" -type f -mtime +${DAYS_TO_KEEP} -delete -print | wc -l)
