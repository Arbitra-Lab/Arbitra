...
This document provides comprehensive guidelines for contributing to the Arbitra smart contracts. It covers Soroban contract architecture, development standards, security considerations, testing requirements, and CI/CD pipeline expectations.
...
**Arbitra Smart Contracts** are Soroban contracts built on the Stellar blockchain for property rental transactions.
...
1. **Arbitra Contract** - Main contract for property listings and bookings
