...
The Agent Registry contract is a Soroban smart contract designed to manage and verify agents within the Arbitra ecosystem. It provides a decentralized way to track agent reputation, verify their identity, and link them to property transactions.
...
Registers a transaction involving an agent. This is typically called by other Arbitra contracts (e.g., Rent Agreement).
