...
This guide explains how the Arbitra backend integrates with Stellar smart contracts, handles payments, manages escrows, and coordinates with external services.
