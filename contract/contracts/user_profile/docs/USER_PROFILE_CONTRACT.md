...
### Purpose
The contract serves as a decentralized identity and profile registry for the Arbitra ecosystem. It maintains a mapping of Stellar addresses to profile metadata, including account types (Tenant, Landlord, Agent) and verification status.
